...
set(ref(db), {
  ...
  maps: {
    ...
    100: {
      mapName: 'Highland Adventure',
      mapLocation: 'Scotland',
      arUrl: '',
      waypoints: [
        {
          title: 'clue one',
    ...
    105: {
      mapName: 'Forest Adventure',
      mapLocation: 'The New Forest ',
      arUrl: '',
      waypoints: [
        {
          title: 'clue one',
    ...
    109: {
      mapName: 'Snowdon Trail',
      mapLocation: 'Snowdonia',
      arUrl: '',
      waypoints: [
        {
          title: 'clue one',
    ...
    110 : {
      mapName: 'Pennine Expedition',
      mapLocation: 'North Pennines',
      arUrl: '',
      waypoints: [
        {
          title: 'clue one',
